...
final class PresentationPreflightTests: XCTestCase {
    ...
    func testEveryRegisteredPresentationCanBeInspectedWithoutProviderOrOrderCredentials() throws {
        let examples = [
            ("APPLE_PAY", "SYSTEM_WALLET_TOKEN", "MELD_WALLET_TOKEN", "native-applepay", false),
            ...
            ("CREDIT_DEBIT_CARD", "EMBEDDED_WIDGET", "BANXA_CHECKOUT", "embedded", true),
    ...
    func testAdvisorySupportCannotAuthorizeAMissingOrInvalidOrderPayload() throws {
        let json: [String: Any] = ["surface": "SYSTEM_WALLET_TOKEN", "protocol": "MELD_WALLET_TOKEN", "version": 1]
    ...
    func testUnknownAndMismatchedDeclarationsFailClosedWithoutLegacyInference() throws {
        for (surface, protocolName, version) in [("SYSTEM_WALLET_TOKEN", "FUTURE_PROTOCOL", 1),
                                                ("SYSTEM_WALLET_TOKEN", "MELD_WALLET_TOKEN", 2),
        ...
        let wallet = try presentation("SYSTEM_WALLET_TOKEN", "MELD_WALLET_TOKEN")
